...
// Points to your backend's /api/contact endpoint. Set VITE_API_URL in your
// frontend .env for production (e.g. https://your-backend.onrender.com);
    ...
    <section className="contactSec" id="contact">
      ...
      <div className="contactGrid">
        ...
        <form className="contactForm" onSubmit={handleSubmit}>
          ...
          {status === "sent" && (
            <p className="formStatus formStatus--ok">
              Thanks for your message! I'll get back to you soon.
            </p>
          )}
          {status === "error" && (
            <p className="formStatus formStatus--error">
